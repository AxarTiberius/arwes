...
var createThemePalette = function (setup) {
    ...
    return Object.freeze(__assign(__assign({}, otherFeatures), { tonalOffset: tonalOffset, elevationOffset: elevationOffset, primary: createThemePaletteBasic_1.createThemePaletteBasic(__assign({ main: '#0ff' }, setup.palette.primary), tonalOffset), secondary: createThemePaletteBasic_1.createThemePaletteBasic(__assign({ main: '#ff0' }, setup.palette.secondary), tonalOffset), success: createThemePaletteBasic_1.createThemePaletteBasic(__assign({ main: '#0f0' }, setup.palette.success), tonalOffset), error: createThemePaletteBasic_1.createThemePaletteBasic(__assign({ main: '#f00' }, setup.palette.error), tonalOffset), text: createThemePaletteBasic_1.createThemePaletteBasic(__assign({ main: '#0ff' }, setup.palette.text), tonalOffset), neutral: createThemePaletteElevation_1.createThemePaletteElevation((_b = (_a = setup.palette.neutral) === null || _a === void 0 ? void 0 : _a.main) !== null && _b !== void 0 ? _b : '#000', elevationOffset) }));
};
